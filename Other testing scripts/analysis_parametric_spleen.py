...
def main() -> None:
    ...
    for i in range(3):
        ...
        if 'sizeCellFluid' in values:
            if 'VolWAkeIn' not in values:
                case_params['VolWAkeIn'] = 0.35 * case_params['sizeCellFluid']
            if 'VolWAkeOut' not in values:
                case_params['VolWAkeOut'] = case_params['sizeCellFluid']
